...
namespace EF_CodeFirst.Controllers
{
    public class GradesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Grade.Include(g => g.Student);
        ...
        public async Task<IActionResult> Create([Bind("GradeId,GradeName,Section,StudentId")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GradeId,GradeName,Section,StudentId")] Grade grade)
        {
            if (id != grade.GradeId)
            {
                return NotFound();
